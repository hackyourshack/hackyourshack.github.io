  ...
  return (
    <Page className={className}>
      <section className="p-2">
        <H1 className="text-accent-1">{title}</H1>
      </section>
        ...
        <Swiper className="h-full">
          <Swiper.Page>
            ...
            <div className="mx-8 my-4">
              ...
              <p>
                You can use the ropes for all kinds of things. They are
                especially helpful for joining in construction, but you can also
                use them as fishing lines or to tow a car.
              </p>
              <img
          ...
          <Swiper.Page>
            ...
            <div className="mx-8 mt-4">
              ...
              <ul className="my-2 ml-6 list-disc">
                ...
                <li>
                  Draw a cross line - with the distance you determine the width
                  of the PET-tape that comes out of your cutter at the end
                </li>
              </ul>
              <p className="mt-6">
          ...
          <Swiper.Page>
            ...
            <img
              ...
              className="object-cover object-bottom w-full h-64 mt-4"
            />
            <div className="mx-8 my-4 font-bold">You are done!</div>
          </Swiper.Page>
          <Swiper.Page>
            <img
            ...
            <div className="mx-8 mt-4">
              ...
              <ul className="my-2 ml-6 list-disc">
                <li>
                  Remove the bottom of a plastic bottle with a cutter knife
                </li>
                <li>
                  Thread the bottle into your plastic bottle cutter at the
                  bottom
                </li>
                <li>
